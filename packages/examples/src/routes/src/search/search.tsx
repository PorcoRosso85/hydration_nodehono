...
import { SearchInput, SearchResults } from '../../../examples/src/search/Search'
import { addIds, contactsListData } from '../../../examples/src/search/data/searchTargetData'
...
app
  ...
  .get('/result', (c) => {
    ...
    return c.html(<SearchResults targetData={addIds(contactsListData)} query={query} />)
  })

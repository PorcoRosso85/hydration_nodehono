...
import { CartItem, ItemAmmountInCart, ShopItems } from '../../../examples/src/cart/CartItem'
import { addedItemToCartData } from '../../../examples/src/cart/data/addedItemToCartData'
...
app
  ...
  .get('/add/:id/amount', async (c) => {
    ...
    if (id === '_') {
      ...
      return c.html(<ItemAmmountInCart cartData={addedItemToCartData} id={id} />)
    }
  })

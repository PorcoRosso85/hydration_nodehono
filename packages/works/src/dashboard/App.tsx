...
import { NavAndIcon } from "./NavAndIcon";
...
const A = function () {
  return html`<a @href="#">hi</a> `;
};

const App = function () {
  const style = `
  hr {
    height: 1px; /* 線の厚みを10ピクセルに設定 */
    margin: 50px 0; /* 上下のマージンを設定 */
  }
  `;
  return (
    <>
      ...
      {/* <div id="all-components">
        <div hx-get="/work/login" hx-trigger="load, "></div>
        <Kanban />
        <hr />
        <div hx-get="/work/nav" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/dashboardsample" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/payment" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/products" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/price" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/chat" hx-trigger="load, "></div>
        <hr />
        <div hx-get="/work/table" hx-trigger="load, "></div>
        <hr />
      </div> */}
      <div hx-target="#target" hx-swap="innerHTML">
        <button
          hx-get="/work/login"

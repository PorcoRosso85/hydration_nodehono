const renderProfileData = (data, isNested = false) => {
  return Object.entries(data).map(([key, value]) => {
    ...
    if (typeof value === "object" && !Array.isArray(value)) {
      return (
        <div key={key} className={isNested ? "nested" : ""}>
...
const Left = (props) => {
  return (
    <div class="mx-auto max-w-[40rem] lg:mx-0 lg:max-w-none lg:flex-none"></div>
  );
};
...
const __profileData = {
  ...
  経験業種: {
    ...
    金融_その他金融: "",
    コンサルティング_専門事務所_監査法人_税理士法人_リサーチ:
      "経営・戦略コンサルティング（現職）",
  },
  語学_資格: {
...
export const profileData = {
  ...
  preferredCompanyEnvironment: {
    ...
    challengingVsConservative: [
      "チャレンジングな経営方針 vs 堅実な経営方針",
      3,
    ],
  },
